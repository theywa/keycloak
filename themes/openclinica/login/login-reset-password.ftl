    ...
    <#elseif section = "form">
        <form id="kc-reset-password-form" class="${properties.kcFormClass!}" action="${url.loginAction}" method="post">
            <div class="${properties.kcFormGroupClass!}">
                <div class="login-pf-signup reset-pass-info">
            ...
            <div id="kc-form-buttons" class="${properties.kcFormGroupClass!} ${properties.kcFormGroupLogin!}">
                <input class="${properties.kcButtonClass!} ${properties.kcButtonPrimaryClass!} ${properties.kcButtonBlockClass!} ${properties.kcButtonLargeClass!} ${properties.kcButtonLogin!}" type="submit" value="${msg("doResetPass")}"/>
            </div>
        </form>
    </#if>
